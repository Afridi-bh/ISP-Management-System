        ...
        <div style="width: 100%; background: white; border-radius: 1.5rem; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); padding: 2.5rem;">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div style="margin-bottom: 1.25rem;">
                    <div style="position: relative;">
                        <x-text-input 
                            id="email" 
                            type="email"
                            style="display: block; width: 100%; padding: 1rem; background: #f9fafb; border: 2px solid #e5e7eb; border-radius: 1rem; color: #374151; transition: all 0.2s;"
                            name="email" 
                ...
                <a href="{{ route('customer.login') }}"
                   style="width: 100%; display: flex; align-items: center; justify-content: center; background: linear-gradient(to right, #f97316, #ea580c); color: white; font-weight: 700; padding: 1rem; border-radius: 1rem; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); text-decoration: none; transition: all 0.2s; font-size: 1rem;"
                   onmouseover="this.style.transform='scale(1.02)'; this.style.boxShadow='0 20px 25px -5px rgba(0, 0, 0, 0.1)'"
                   onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 10px 15px -3px rgba(0, 0, 0, 0.1)'"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" style="height: 1.25rem; width: 1.25rem; margin-right: 0.5rem;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 1.5rem;">
                    <div style="display: flex; align-items: center;">
                        <input 
                            id="remember_me" 
                            type="checkbox"
                            style="width: 1rem; height: 1rem; border-radius: 0.25rem; border: 1px solid #d1d5db; color: #2563eb;"
                            name="remember"
                        />
                    ...
                    @if (Route::has('password.request'))
                        <a style="font-size: 0.875rem; color: #2563eb; font-weight: 500; text-decoration: none;" href="{{ route('password.request') }}">
                            Forgot Password?
                        </a>
                    @endif
                </div>
            ...
            @if (Route::has('register'))
                <div style="margin-top: 2rem; text-align: center;">
                    <p style="color: #6b7280; font-size: 0.875rem;">
                        ...
                        <a href="{{ route('register') }}" style="color: #2563eb; font-weight: 600; text-decoration: none;">Sign Up</a>
                    </p>
                </div>
            @endif
